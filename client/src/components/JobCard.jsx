  ...
  return (
    <div className='border p-6 shadow rounded'>
     ...
     <div className='flex gap-3 items-center  mt-2 text-xs'>
        <sapn className='bg-red-50 border border-red-200 px-4 py-1.5 rounded'> {job.location} </sapn> 
     ...
     <div className='mt-4 flex gap-4 text-sm'>
        ...
        <button onClick={() => { navigate(`/apply-job/${job._id}`); scrollTo(0, 0) }}  className=' border border-gray-600  text-gray px-4 py-2 rounded'>Learn more</button>
     </div>
    </div>
  )
}
